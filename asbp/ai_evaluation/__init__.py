...
# M17.4 exports — Retrieval-use rules and source-role discipline.
from .retrieval_use_rules import (
    AI_RETRIEVAL_USE_CHECK_STATUS_VALIDATED,
    AI_RETRIEVAL_USE_RULES_CHECKPOINT_ID,
    AI_RETRIEVAL_USE_RULES_CONTRACT_VERSION,
    AI_RETRIEVAL_USE_RULE_STATUS_VALIDATED,
    AI_SOURCE_ROLE_DISCIPLINE_CHECK_STATUS_VALIDATED,
    APPROVAL_OR_RELEASE_REQUEST_FAILURE as RETRIEVAL_APPROVAL_OR_RELEASE_REQUEST_FAILURE,
    ...
    STATE_MUTATION_REQUEST_FAILURE as RETRIEVAL_STATE_MUTATION_REQUEST_FAILURE,
    ...
    build_retrieval_use_check_result,
    build_source_role_discipline_check_result,
    validate_ai_retrieval_use_rule_result,
    validate_retrieval_use_check_result,
    validate_source_role_discipline_check_result,
)
...
__all__.extend([
    ...
    "AI_RETRIEVAL_USE_RULE_STATUS_VALIDATED",
    "AI_SOURCE_ROLE_DISCIPLINE_CHECK_STATUS_VALIDATED",
    "RETRIEVAL_APPROVAL_OR_RELEASE_REQUEST_FAILURE",
    "ASSET_PAYLOAD_INCLUDED_FAILURE",
    "DOCUMENT_GENERATION_REQUEST_FAILURE",
    "DOCUMENT_TEMPLATE_IMPLEMENTATION_REQUEST_FAILURE",
    "EXECUTION_TRUTH_OVERRIDE_FAILURE",
    ...
    "SOURCE_ROLE_DISCIPLINE_CHECK_PASS",
    "SOURCE_TRUTH_OVERRIDE_FAILURE",
    "RETRIEVAL_STATE_MUTATION_REQUEST_FAILURE",
    "SUPPORT_RETRIEVAL_COMPILED_AUTHORITY_FAILURE",
    "SUPPORT_RETRIEVAL_EXECUTION_TRUTH_FAILURE",
    "SUPPORT_RETRIEVAL_GOVERNED_EVIDENCE_FAILURE",
    "SUPPORT_RETRIEVAL_SOURCE_TRUTH_FAILURE",
