...
def test_filter_tasks_by_task_key_and_status_with_and_logic():
    ...
    assert [task["task_id"] for task in result] == ["TASK-002"]
def test_filter_tasks_by_exact_task_id_only():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
    ...
    result = filter_tasks(tasks, task_id="TASK-002")

    assert [task["task_id"] for task in result] == ["TASK-002"]


def test_filter_tasks_by_task_id_and_status_with_and_logic():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
...
def test_filter_tasks_by_exact_dependency_task_id_only():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
    ...
    result = filter_tasks(tasks, dependency_task_id="TASK-001")

    assert [task["task_id"] for task in result] == ["TASK-002", "TASK-003"]


def test_filter_tasks_by_dependency_task_id_and_status_with_and_logic():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
...
def test_filter_tasks_by_exact_dependent_task_id_only():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
    ...
    result = filter_tasks(tasks, dependent_task_id="TASK-003")

    assert [task["task_id"] for task in result] == ["TASK-001", "TASK-002"]


def test_filter_tasks_by_dependent_task_id_and_status_with_and_logic():
    tasks = [
        {
            "task_id": "TASK-001",
            "title": "Task 1",
